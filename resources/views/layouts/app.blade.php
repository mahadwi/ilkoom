        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right p-0 border-0">
              <a class="dropdown-item bg-dark text-white p-2 text-center" href="{{ route('logout') }}" onclick="event.preventDefault();
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 text-center text-md-left">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur autem praesentium quis dolorem consequatur beatae ducimus in nemo similique corporis!</p>
          </div>
          ...
          <div class="col-md-3 text-center">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="#" class="text-white">Privacy Poliy</a></li>
          ...
          <div class="col-md-3 text-center text-md-left">
            <h5>Hubungi Kami</h5>
            <div class="text-nowrap"><i class="fas fa-envelope fa-fw mr-3"></i>mahadwiputra008@gmail.com</div>
            <div class="text-nowrap"><i class="fas fa-phone fa-fw mr-3"></i>135(021) 123456</div>
        ...
        <div class="row mt-3 mt-md-0">
          ...
          <div class="col-md-3 mr-md-auto text-center text-md-left">
            <div>
              ...
              <a href="#" class="text-white mr-2"><i class="fab fa-github fa-lg"></i></a>
            </div>
          </div>
        </div>
      </div>
